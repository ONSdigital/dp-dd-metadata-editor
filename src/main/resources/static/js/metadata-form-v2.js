...
$(document).ready(function() {
    ...
    $("#create-metadata-form").submit(function(e) {
        var form = extractFormValues();
        submitForm(e, "POST", "/metadata", form);
    });

    $("#update-metadata-form").submit(function(e) {
        var form = extractFormValues();
        form.datasetId = $("#hidden-dataset-id").text();
        submitForm(e, "PUT", "/metadata/" + form.datasetId, form);
    });
...
function submitForm(e, method, url, form) {
    e.preventDefault();
